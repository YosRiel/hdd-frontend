...
const CombosAndSnacks: React.FC = () => {
  return (
    <div>
      ...
      {/* Interfaz de combos y dulcería online */}
      <h2 className="mt-8 text-2xl font-bold">Combos y Dulcería</h2>
    </div>
  );
};

export default CombosAndSnacks;
