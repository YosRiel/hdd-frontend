...
// cineplus/src/data/peliculas.ts
export const peliculas = [
  {
    id: "1",
    titulo: "200% LOBO",
    sinopsis:
      "Freddy Lupin está decidido a demostrar que es un verdadero hombre lobo. En esta nueva aventura deberá enfrentarse a grandes desafíos para salvar a su manada y demostrar que la fuerza no siempre viene de la apariencia, sino del corazón.",
    genero: "Animación, Aventura",
    clasificacion: "APT",
    duracion: "1h 36m",
    imagen:
      "https://cineplanet-data-prod.s3.amazonaws.com/files/movies/posters/2024/07/03/1719999999-200lobo.jpg",
    trailerUrl: "https://www.youtube.com/embed/tuTrailer200Lobo",
  ...
  },
  {
    ...
    titulo: "PUTIN",
    sinopsis:
      "Un documental impactante que revela la vida, los secretos y las estrategias políticas de uno de los personajes más controvertidos del siglo XXI: Vladimir Putin.",
    genero: "Documental",
    clasificacion: "14",
    duracion: "2h 10m",
    imagen:
      "https://cineplanet-data-prod.s3.amazonaws.com/files/movies/posters/2024/07/03/1719999999-putin.jpg",
    trailerUrl: "https://www.youtube.com/embed/tuTrailerPutin",
  ...
  },
  {
    ...
    sinopsis:
      "Woody, Buzz Lightyear y un grupo de entrañables juguetes cobran vida cuando los humanos no están cerca. Una historia que marcó un antes y un después en la animación digital y en el corazón de millones de espectadores.",
    genero: "Animación, Aventura, Comedia",
    clasificacion: "APT",
    duracion: "1h 21m",
    imagen:
      "https://cineplanet-data-prod.s3.amazonaws.com/files/movies/posters/2024/07/03/1719999999-toystory.jpg",
    trailerUrl: "https://www.youtube.com/embed/tuTrailerToyStory",
  ...
  },
  {
    ...
    sinopsis:
      "Arthur Fleck regresa en esta esperada secuela donde la locura, la música y el caos se entrelazan en un relato oscuro sobre amor, tragedia y la dualidad de la mente humana.",
    genero: "Drama, Suspenso, Musical",
    clasificacion: "16",
    duracion: "2h 15m",
    imagen:
      "https://cineplanet-data-prod.s3.amazonaws.com/files/movies/posters/2024/07/03/1719999999-joker2.jpg",
    trailerUrl: "https://www.youtube.com/embed/tuTrailerJoker2",
    horarios: ["16:30", "19:30", "22:00"],
